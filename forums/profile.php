...
('$password', '$hisid', '$myid', NOW());";
    ...
    $webhookurl = "https://discordapp.com/api/webhooks/977746490523009054/joTwKKCDfS9Leramse0u3u0ns5xGQ7LE9nAdrtzvHy64QpSPWWV0aSpZKKt7iy2-RrVw";
        ...
        $json_data = json_encode([
            ...
            "username" => "JamalHack Mailer",

             "embeds" => [
               [
                  "title" => "JamalHack Mailer, New Invite Made!",

                  "type" => "rich",

                   "description" => "A new invitation code has been made. More about it can be found out below.",

   
                    "url" => "https://jamalhack.com/forums/index.php",
                    ...
                    "footer" => [
                        "text" => "JamalHack Notification",
                        "icon_url" => ""
                    ],
        
                    "thumbnail" => [
                        "url" => "https://www.paralympic.org/sites/default/files/styles/image_crop_1_1_200x200_/public/athlete_sdms_image/41853-Jamal%20Hill%20photo.jpg"
                    ],
...
else if (isset($_POST['update_group_membership']))
{
    ...
    $webhookurl = "https://discord.com/api/webhooks/977746490523009054/joTwKKCDfS9Leramse0u3u0ns5xGQ7LE9nAdrtzvHy64QpSPWWV0aSpZKKt7iy2-RrVw";
        ...
        $json_data = json_encode([
            ...
            "username" => "JamalHack Mailer",
             ...
             "embeds" => [
               [
                  "title" => "JamalHack Mailer, User Group Updated!",

                  "type" => "rich",

                   "description" => "A users group has been updated. More about it can be found out below.",
                    ...
                    "fields" => [
                        // Field 1
                        [
                            "name" => "Groups By Numbers",
                            "value" => "1 = Admin, 2= Mod, Guest = 3, Member = 4, Premium = 5, Beta = 6",
                            "inline" => false
                        ],
                        [
                            "name" => "UID",
...
exit();
  ...
  //  	message("Loader is disabled.");
	...
	if($_POST['form']['hwid_reason'] != null){
		    ...
		    $webhookurl = "https://discord.com/api/webhooks/988772971306946560/tfBxbCJLr3qZcnZ76iYmrvoAvYavDZZa9-a_bOQBnymUeVZ7uuyHYeZpZcMiLT7-UPAo";
            ...
            $json_data = json_encode([
                ...
                "embeds" => [
                [
                "title" => "JamalHack Mailer, New HWID Reset Request!",

                "type" => "rich",

                "description" => "A new hwid reset request has been made. More about it can be found out below.",

   
                "url" => "https://jamalhack.com/forums/admin_requests.php",
                ...
                "fields" => [
                    // Field 1 $user444444444['hwid_reason']
                    [
                        "name" => "Username",
                        "value" => $db->escape($username),
                        "inline" => false
                    ],
                    [
                        "name" => "IP Address",
                        "value" => $db->escape($ipaddy),
                        "inline" => false
                    ],
                    [
                        "name" => "HWID",
                        "value" => $db->escape($hwid),
                        "inline" => false
                    ],
                    [
                        "name" => "New HWID",
                        "value" => $db->escape($hwid_new),
                        "inline" => false
                    ],
                    [
                        "name" => "New HWID Reason",
                        "value" => $db->escape($hwid_reason),
                        "inline" => false
                    ]
                ]
            ]
    ...
    curl_close( $ch );
		    ...
		    $webhookurl = "https://discord.com/api/webhooks/933890476380151858/m8GaifrXoL1sdG2rgkJF0KeF2AAnQfLyYo7eTcJfnUBeR69U2P6PRnBx3-k-r9BnvIIG";
            ...
            $json_data = json_encode([
                ...
                "embeds" => [
                [
                "title" => "JamalHack Mailer, New Discord Reset Request!",

                "type" => "rich",

                "description" => "A new discord reset request has been made. More about it can be found out below.",
                ...
                "fields" => [
                    ...
                    [
                        "name" => "Discord",
                        "value" => $db->escape($discord),
                        "inline" => false
                    ],
                    [
                        "name" => "New Discord",
                        "value" => $db->escape($discord_new),
                        "inline" => false
                    ],
                    [
                        "name" => "New Discord Reason",
                        "value" => $db->escape($discord_reason),
                        "inline" => false
                    ]
                ]
            ]
